...
curl https://raw.githubusercontent.com/roberd13/insights-tutorial/master/tg_dse.json -o prometheus/tg_dse.json
...
curl https://raw.githubusercontent.com/roberd13/insights-tutorial/master/prometheus.conf -o prometheus.conf

# Download Docker compose yaml
curl https://raw.githubusercontent.com/roberd13/insights-tutorial/master/insights-compose.yaml -o insights-compose.yaml
